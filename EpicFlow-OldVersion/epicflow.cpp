...
{
    const char *im1_path = "D:/CmakeProject/OpticalFlow/EpicFlow-OldVersion/MPI-Sintel/frame_0029.ppm";
    const char *im2_path = "D:/CmakeProject/OpticalFlow/EpicFlow-OldVersion/MPI-Sintel/frame_0030.ppm";
    const char *edges_path = "D:/CmakeProject/OpticalFlow/EpicFlow-OldVersion/MPI-Sintel/frame_0029_edges.txt";
    const char *matches_path = "D:/CmakeProject/OpticalFlow/EpicFlow-OldVersion/MPI-Sintel/frame_0029_matches.txt";
    const char *optflow_path = "D:/CmakeProject/OpticalFlow/EpicFlow-OldVersion/MPI-Sintel/frame_0029_optflow.flo";

    // read arguments
    color_image_t *im1 = color_image_load(im1_path);
    color_image_t *im2 = color_image_load(im2_path);
    float_image edges = read_edges(edges_path, im1->width, im1->height);
    float_image matches = read_matches(matches_path);
    const char *outputfile = optflow_path;
    ...
    //     // read arguments
    //     const char *im1_path = argv[1];
    //     const char *im2_path = argv[2];
    //     const char *edges_path = argv[3];
    //     const char *matches_path = argv[4];
    //     const char *optflow_path = argv[5];
    ...
    //     variational(wx, wy, im1, im2, &flow_params);
    //     // write output file and free memory
    //     writeFlowFile(optflow_path, wx, wy);
