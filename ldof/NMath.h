...
namespace NMath
{
  ...
  inline float arctan(float x, float y)
  {
    if (x == 0.0)
      if (y >= 0.0)
        return 0.5 * 3.1415926536;
      else
        return 1.5 * 3.1415926536;
    else if (x > 0.0)
      if (y >= 0.0)
        return atan(y / x);
      else
        return 2.0 * 3.1415926536 + atan(y / x);
    else
      return 3.1415926536 + atan(y / x);
  }
  ...
  inline float randomGauss()
  {
    ...
    if (a > 0.0)
      return sqrt(-2.0 * log(a)) * cos(2.0 * 3.1415926536 * b);
    else
      return 0;
  }
